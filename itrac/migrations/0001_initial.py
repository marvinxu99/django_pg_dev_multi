    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_type', models.CharField(choices=[('BREAK_FIX', 'Break/fix'), ('FEATURE', 'New feature'), ('OPTIMIZATION', 'Optimization')], default='BREAK_FIX', max_length=20)),
                ('status', models.CharField(choices=[('OPEN', 'Open'), ('INVESTIGATE', 'Investigate'), ('TRRIAGE', 'Await Approval'), ('BUILD_IN_PROGRESS', 'Build in progress'), ('VALIDATE', 'Validate'), ('COMPLETE', 'Complete'), ('CLOSED', 'Closed')], default='TODO', max_length=20)),
