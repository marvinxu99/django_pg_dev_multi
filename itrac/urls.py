...
urlpatterns = [
    ...
    path('new/', views.create_issue, name='new_issue'),
    path('<int:pk>/edit/', views.edit_issue, name='edit_issue'),
    path('<int:issue_pk>/new/', views.create_or_edit_comment, name='new_comment'),
    path('<int:issue_pk>/<int:pk>/edit/', views.create_or_edit_comment, name='edit_comment'),
    path('<int:issue_pk>/<int:comment_pk>/new/', views.create_or_edit_reply, name='new_reply'),
    path('<int:issue_pk>/<int:comment_pk>/<int:pk>/edit/', views.create_or_edit_reply, name='edit_reply'),
    ...
    path('<int:pk>/save_issue/', views.save_issue, name='save_issue'),
    path('<int:pk>/delete_saved_issue/', views.delete_saved_issue, name='delete_saved_issue'),
]