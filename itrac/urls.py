...
urlpatterns = [
    ...
    path('comment/<int:issue_pk>/new/', views.create_or_edit_comment, name='new_comment'),
    path('comment/<int:issue_pk>/<int:pk>/edit/', views.create_or_edit_comment, name='edit_comment'),
